...
def default_inputs_visualize():
    kw_dict = {
        ...
        'average': [bool, 'Average over all samples to get one averaged curve', False, 'Averaging over all samples'],
        ...
        'path_comp_dataset': [str, 'Path to a csv dataset for rescaling or comparison; comparison only for t-SNE or PCA;', os.path.join('data', 'ganAverageERP.csv'), 'Training dataset: '],
        'kw_timestep': [str, 'Keyword for the time step of the dataset', 'Time', 'Keyword for the time step of the dataset: '],
        'conditions': [str, '** Conditions to be used', '', 'Conditions: '],
        'channel_label': [str, 'Column name to detect used channels', '', 'Channel label: '],
