...
def default_inputs_training_gan():
    kw_dict = {
        ...
        'counterfactual_lr': [float, 'If true, decreasing one learning rate will increase the other learning rate by a proportion scheduler factor (e.g., g_scheduler:0.1 * counterfactual_lr:0.5 = 0.05)', None, 'Counterfactual factor: '],
    }
