...
class AETrainer(Trainer):
    ...
    def __init__(self, model, opt):
        ...
        self.configuration = {
            ...
            'learning_rate': self.learning_rate,
            'hidden_dim': opt['hidden_dim'],
            'sequence_length': opt['sequence_length'] if 'sequence_length' in opt else 0,
            'path_dataset': opt['path_dataset'] if 'path_dataset' in opt else None,
            ...
            'dataloader': {
                ...
                'std_data': opt['std_data'] if 'std_data' in opt else None,
                'norm_data': opt['norm_data'] if 'norm_data' in opt else None,
                'sort_data': opt['sort_data'] if 'sort_data' in opt else None,
                'kw_timestep': opt['kw_timestep'] if 'kw_timestep' in opt else None,
                'channel_label': opt['channel_label'] if 'channel_label' in opt else None,
                'participant_label': opt['participant_label'] if 'participant_label' in opt else None,
                'condition_label': opt['condition_label'] if 'condition_label' in opt else None,
            },
