...
for participant_number = participants
    ...
    gen_fn = '_MMN_ds_reref_ucbip_hpfilt_ica_corr_cbip_elist_bins_epoch_interp_ar';
    ...
    %Relabel events
    labels(labels == 80) = 0; %Standard
    labels(labels == 70) = 1; %Deviant
    label_binary=labels;
...
%Save file
save_filename = '../Full Datasets/erpcore_MMN_full.csv';
