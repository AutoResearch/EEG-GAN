...
def main(run_TFT=True, process_synthetic=True, run_gan=True, run_vae=True):
    ...
    EEG_data = np.genfromtxt(f'data/antisaccade/Full Datasets/antisaccade_left_full.csv', delimiter=',', skip_header=1)[:,1:] #Removes Participant Column
    EEG_data = np.delete(EEG_data, 2, 1) #Delete Unused Column (Trial)
    ...
    if run_gan:
        ...
        gan_fn_0 = f'generated_samples/antisaccade/Full Datasets/gan_antisaccade_full_c0.csv'
        gan_fn_1 = f'generated_samples/antisaccade/Full Datasets/gan_antisaccade_full_c1.csv'
    ...
    if run_vae:
        ...
        vae_fn_0 = f'generated_samples/antisaccade/Full Datasets/vae_antisaccade_full_c0.csv'
        vae_fn_1 = f'generated_samples/antisaccade/Full Datasets/vae_antisaccade_full_c1.csv'
    ...
    time  = np.linspace(0,100,125)/100
    ...
    fig.savefig(f'figures/Figure N - Antisaccade_Evaluations.png', dpi=600)
