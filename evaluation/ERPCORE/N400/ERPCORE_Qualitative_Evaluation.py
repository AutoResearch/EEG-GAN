...
###############################################
def main(run_TFT=True, process_synthetic=True):
    ...
    EEG_data = np.genfromtxt(f'data/ERPCORE/N400/Full Datasets/erpcore_N400_full.csv', delimiter=',', skip_header=1)[:,1:] #Removes Participant Column
    ...
    vae_fn_0 = f'generated_samples/ERPCORE/N400/Full Datasets/vae_erpcore_N400_full_c0.csv'
    vae_fn_1 = f'generated_samples/ERPCORE/N400/Full Datasets/vae_erpcore_N400_full_c1.csv'
    ...
    fig.savefig(f'figures/Figure N - ERPCORE_N400_Evaluations.png', dpi=600)
...
if __name__ == '__main__':
    ...
    main(run_TFT=run_TFT, process_synthetic=process_synthetic)
