...
def main(try_=None):
    ...
    def plot_FFT(c0, c1, num_item, ylim, num_rows=5, difference=False):
        ...
        #Row labels
        if num_item == 1:
            plt.text(-0.1, 1.1, 'Reinforcement\nLearning (E1: FCz)', horizontalalignment='left', verticalalignment='center', transform=ax1.transAxes, fontsize=14, fontweight='bold')
        if num_item == 4:
            plt.text(-0.1, 1.1, 'Reinforcement\nLearning (E8: POz)', horizontalalignment='left', verticalalignment='center', transform=ax1.transAxes, fontsize=14, fontweight='bold')
        elif num_item == 7:
            plt.text(-0.1, 1.1, 'Anti-Saccade', horizontalalignment='left', verticalalignment='center', transform=ax1.transAxes, fontsize=14, fontweight='bold')
        elif num_item == 10:
            plt.text(-0.1, 1.1, 'Face Perception', horizontalalignment='left', verticalalignment='center', transform=ax1.transAxes, fontsize=14, fontweight='bold')
        elif num_item == 13:
            plt.text(-0.1, 1.1, 'Visual Search', horizontalalignment='left', verticalalignment='center', transform=ax1.transAxes, fontsize=14, fontweight='bold')
        ...
        if num_item == 1 or num_item == 4 or num_item == 7 or num_item == 10 or num_item == 13:
            if difference:
                plt.ylabel( r'Power ($\mu$$V^2$) Difference', fontsize=16)
            else:
                plt.ylabel( r'Power ($\mu$$V^2$)', fontsize=16)
