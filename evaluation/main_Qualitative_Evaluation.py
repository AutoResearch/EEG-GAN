...
def main(run_TFT=True, process_synthetic=True, run_gan=True, run_vae=True, component='N400'):
    ...
    if run_vae:
        ...
        vae_fn_0 = f'generated_samples/ERPCORE/{component}/Full Datasets/vae_erpcore_{component}_full_c0.csv'
        vae_fn_1 = f'generated_samples/ERPCORE/{component}/Full Datasets/vae_erpcore_{component}_full_c1.csv'
