...
def retrieveData(data, component='N400'): 
    ...
    ##Full Time-Series
    if data == 1:
        augData = f'classification/ERPCORE/{component}/Classification Results/ganPredictions_e1_NN.csv'
        empData = f'classification/ERPCORE/{component}/Classification Results/empPredictions_e1_NN.csv'
    if data == 2:
        augData = f'classification/ERPCORE/{component}/Classification Results/ganPredictions_e1_SVM.csv'
        empData = f'classification/ERPCORE/{component}/Classification Results/empPredictions_e1_SVM.csv'
    if data == 3:
        augData = f'classification/ERPCORE/{component}/Classification Results/ganPredictions_e1_LR.csv'
        empData = f'classification/ERPCORE/{component}/Classification Results/empPredictions_e1_LR.csv'
    if data == 4:
        augData = f'classification/ERPCORE/{component}/Classification Results/ganPredictions_e1_RF.csv'
        empData = f'classification/ERPCORE/{component}/Classification Results/empPredictions_e1_RF.csv'
    if data == 5:
        augData = f'classification/ERPCORE/{component}/Classification Results/ganPredictions_e1_KNN.csv'
        empData = f'classification/ERPCORE/{component}/Classification Results/empPredictions_e1_KNN.csv'
...
def main(component, xLabels, data):
    ###############################################
    ## SETUP FIGURE                              ##
    ###############################################
    ...
    for dat in data:
        ...
        legendNames = []
        empData, augData = retrieveData(dat, component)
    ...
    fig.savefig(f'figures/Figure N - GAN Classification Results ({component}).png', dpi=600, facecolor='white', edgecolor='none')
