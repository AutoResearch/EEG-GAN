...
def load_synthetic(synFilename_0, synFilename_1, features):
    ...
    Syn0_dataloader = Dataloader(synFilename_0, kw_conditions='Condition 0', kw_channel='Electrode') #TODO: Condition has 0 in header
    synData_0 = Syn0_dataloader.get_data(shuffle=False).detach().numpy()

    Syn1_dataloader = Dataloader(synFilename_1, kw_conditions='Condition 0', kw_channel='Electrode')
...
def load_test_data(validationOrTest, electrode_number, features):
    if validationOrTest == 'validation':
        EEGDataTest_fn = f'data/ERPCORE/N400/Validation and Test Datasets/erpcore_N400_validation.csv'
    else:
        EEGDataTest_fn = f'data/ERPCORE/N400/Validation and Test Datasets/erpcore_N400_test.csv'
