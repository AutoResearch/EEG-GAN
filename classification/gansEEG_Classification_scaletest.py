                ...
                for run in range(5): #Conduct analyses 5 times per sample size
                    ...
                    if add_synthetic_data:
                        ...
                        if features: #If extracting features
                            ...
                            synPredictors = np.expand_dims(scale(synFeatures[:,:,0], axis=1),2) #Extract normalized raw EEG
                    ...
                    if features: #If extracting features
                        ...
                        X_train = np.expand_dims(scale(EEG_data[:,1:,0], axis=1), 2) #Extract normalized raw EEG
